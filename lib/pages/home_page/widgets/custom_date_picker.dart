  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          TextButton(
            ...
            child: Container(
              ...
              child: Center(
                  child: Text(
                /*widget.cancelText ?? localizations.cancelButtonLabel*/ "Cancel",
          ...
          TextButton(
            ...
            child: Container(
              ...
              child: Center(
                  child: Text(
                /*widget.confirmText ?? localizations.okButtonLabel*/ "Save",
    ...
    return Dialog(
        ...
        child: SingleChildScrollView(
          ...
          child: Wrap(
            children: [
              widget.presets ?? Container(),
              Container(
                constraints:
                    BoxConstraints(maxHeight: size.height * 0.6, minWidth: dialogSize.width * 2),
                decoration: BoxDecoration(
                    // color: Colors.amber,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(dateToString(widget.initialDate)),
                        )
                      ],
                    ),
                  ),
